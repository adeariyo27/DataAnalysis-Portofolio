...
"""## Payment Method with The Biggest Average Median Price"""

median_price = order_df["price"].groupby(order_df["payment_type"]).median().sort_values(ascending=0)
median_price
...
"""## Average Weight and Standard Deviation of Product Category"""

print('Average Weight Product\n')
